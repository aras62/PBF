function [pred_boxes, scores, box_deltas_, anchors_, scores_] = proposal_im_detect_jaad(conf, caffe_net, im)
...
function [boxes, scores] = filter_boxes(min_box_size, boxes, scores)
    ...
    valid_ind = widths >= min_box_size & heights >= min_box_size &heights >= 50;
