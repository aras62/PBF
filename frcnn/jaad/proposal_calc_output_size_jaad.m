function [output_width_map, output_height_map] = proposal_calc_output_size_jaad(conf, test_net_def_file)
...
% --------------------------------------------------------
    ...
    for i = 1:length(input)
        ...
        cls_score = caffe_net.blobs(conf.rpn_cls_score).get_data();%'proposal_cls_score'
