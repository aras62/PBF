function bbs = acfDetect_check( I, detector, fileName )
...
if(~multiple), bbs=acfDetectImg_check(I,detector); else
  n=length(I); bbs=cell(n,1);
  parfor i=1:n, bbs{i}=acfDetectImg_check(I{i},detector);end%parfor
end
...
function bbs = acfDetectImg_check( I, detector )
